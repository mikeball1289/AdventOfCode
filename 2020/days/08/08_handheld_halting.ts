import { Instruction, convertToInstructionLabel, CPU, InstructionLabel } from '../../lib/CPU';
import { openAoC } from '../../../lib/input/openAoC';

const input = openAoC('./2020/input/day8input.txt', ['\n', ' ']);
...
console.log(cpu.halts().cpu.accumulator); // 1446
